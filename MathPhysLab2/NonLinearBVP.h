...
public:
   ...
   //vector<double> u_1;        // Приближение функции u по нелинейности на предыдущей итерации
   vector<double> u;          // Приближение функции u по нелинейности на текущей итерации
